...
public class Constants {
	...
	static  {
		...
		try{
			pro.load(new FileInputStream("/Users/yanpeiying/Documents/ch9.properties"));
	    } catch (Exception e)  {
	    	System.out.println("Fatal error: Can not open the ch9.properties file");
	    	System.exit(3);
	    }
	    ...
	    ROWS_A = Integer.parseInt(pro.getProperty("matrix_A_rows", "8"));
	    COLUMNS_A = Integer.parseInt(pro.getProperty("matrix_A_cols", "8"));
	    ROWS_B = COLUMNS_A;
	    COLUMNS_B = Integer.parseInt(pro.getProperty("matrix_B_cols", "8"));
	    PART1_LEN = Integer.parseInt(pro.getProperty("part1_length", "4"));
